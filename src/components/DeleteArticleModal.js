...
function DeleteArticleModal({toggleDeleteArticleModal}) {
    const {article, isDeletingArticle} = useSelector(state => state.articles);
    const dispatch = useDispatch();
    let history = useHistory();

    const handleDeleteArticle = async () => {
        await dispatch(actions.articles.deleteArticle(article));
