...
function SignUp() {
    const {isLoggedIn, isRegistering} = useSelector(state => state.auth);
    ...
    const formik = useFormik({
        ...
        onSubmit: ({name, email, password}) => {
            dispatch(actions.auth.register(name, email, password))
                .then(status => {
                            ...
                            <form action="#" className="space-y-6">
                                <div>
                                    ...
                                    <p className="mt-2 text-sm font-medium text-red-500"
                                       id="name-error">{formik.errors.name}</p>}
                                </div>
                                <div>
                                ...
                                <div>
                                    <button type="submit"
                                        ...
                                        {isRegistering
                                            ...
                                            : <span className="h-5">Sign up</span>
                                        }
                                    </button>
                                </div>
                            </form>
