...
function EditArticle() {
    ...
    const {article, isUpdatingArticle} = useSelector(state => state.articles);
    ...
    const formik = useFormik({
        ...
        validate,
        onSubmit: (values) => {
            dispatch(actions.articles.updateArticle(values))
                .then(article => {
                    formik.resetForm();
        ...
        <div>
            ...
            <div className="mx-auto max-w-3xl sm:my-24 px-8 my-16">
                <form action="#" className="space-y-8">
                    <div>
                        <h3 className="text-lg leading-6 font-medium text-gray-900">Edit article</h3>
